        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            {projects.map((project) => (
              ...
              >
                <div className="group relative bg-transparent/20 backdrop-blur-md rounded-3xl border border-border hover:border-primary/50 transition-all duration-500 hover:shadow-card overflow-hidden w-full">
                  {/* Cover Image */}
                  {project.image && (
